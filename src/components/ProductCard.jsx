...
function ProductCard ({ img, price, description, type = 'small', tag }) {
  ...
  return (
    ...
    >
      ...
      {type === 'big'
        ? (
          <div className='absolute -bottom-32 flex w-full flex-row items-center justify-center gap-4 bg-orange-600 p-2 transition-all group-hover:bottom-0' onAuxClick={handleClick}>
